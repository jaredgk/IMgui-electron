...
//JK 3/10/16: add additional include for stringstream and tinyxml
#include "tinyxml.h"
#include "tinystr.h"
#include <cstdlib>
#include <sstream>

//JK 3/14/16: add ifndef/define/endif for XML writing macro
/*#ifndef XML_ENABLED
#define XML_ENABLED
#endif*/
...
//AS: adding thermosum as a gextern, so it can be accessed in marglike, output.cpp
gextern double thermosum[MAXCHAINS];
gextern double thermobetas[MAXCHAINS];
//gextern double tempthermosums[MAXCHAINS];
...
void printhistograms (FILE * outfile, long int recordstep,
                      double generationtime, double scaleumeaninput, char * filename);
...
//JK 3/10/16: change return type for XML
TiXmlElement *printrunbasics (FILE * outfile, int loadrun, char fpstr[],
...
//JK 3/10/16: change return type for XML (for next three functions)
...
//#endif
//JK 3/10/16: change return type for XML
TiXmlElement *printchaininfo (FILE * outto, int heatmode, 
...
//AS: Mon Nov 30 17:14:59 EST 2015 Adding currentid to this
